  ...
  return (
    <div className={classes.cartWrapper}>
      <div className="container">
        <Typography variant="h4"><u>Cart page</u></Typography>
        <br/>
              ...
              <div className="cart-list-item" key={cartItem.id}>
                ...
                <div className="cart-item-content">
                  ...
                  <div className="cart-item-bottom-content">
                    ...
                    <Button onClick={() => removeItem(cartItem.id)} variant="contained" color="secondary">Remove</Button>
                  </div>
                </div>
              </div>
            );
        ...
        <div className="btn-wrapper">
          <Button className="btn pink-btn" onClick={placeOrder} color="secondary" variant="contained">
            Place order
          </Button>
        </div>
      </div>
